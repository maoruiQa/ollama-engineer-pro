...
MAINMODEL = "mistral-nemo:12b-instruct-2407-q6_K"  # Maintains conversation history and file contents

# Models that don't maintain context (memory is reset after each call)
TOOLCHECKERMODEL = "mistral-nemo:12b-instruct-2407-q6_K"
CODEEDITORMODEL = "qwen2.5-coder:7b-instruct-q8_0"
...
async def generate_edit_instructions(
    ...
    global code_editor_memory, code_editor_files
    try:
